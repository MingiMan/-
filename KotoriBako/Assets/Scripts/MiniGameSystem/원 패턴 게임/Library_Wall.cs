...
public class Library_Wall : Props
{
    [SerializeField] GameObject libraryTransfer;
    ...
    private void OnEnable()
    {
        ...
        libraryTransfer.gameObject.SetActive(false);
    ...
    IEnumerator Go()
    {
        ...
        libraryTransfer.gameObject.SetActive(true);
